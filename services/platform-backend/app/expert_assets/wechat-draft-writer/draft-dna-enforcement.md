...
## Style DNA input
Use the writing_dna supplied by the platform. Current user instructions and confirmed
preferences take precedence. If no personal DNA exists, use the bundled default style.
Do not read or write local author files or treat unconfirmed reference style as a saved preference.
